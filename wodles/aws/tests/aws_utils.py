...
def get_wazuh_integration_parameters(service_name: str = constants.TEST_SERVICE_NAME, profile: str = constants.TEST_AWS_PROFILE,
...
def get_wazuh_aws_database_parameters(service_name: str = constants.TEST_SERVICE_NAME, profile: str = constants.TEST_AWS_PROFILE,
                                      db_name: str = constants.TEST_DATABASE, access_key: str = None, secret_key: str = None,
                                      iam_role_arn: str = None, region: str = None, discard_field: str = None,
                                      discard_regex: str = None, sts_endpoint: str = None, service_endpoint: str = None,
                                      iam_role_duration: str = None, external_id: str = None):
...
def get_aws_bucket_parameters(db_table_name: str = constants.TEST_TABLE_NAME, bucket: str = constants.TEST_BUCKET, reparse: bool = False,
                              profile: str = constants.TEST_AWS_PROFILE, access_key: str = None, secret_key: str = None,
...
def get_aws_service_parameters(db_table_name: str = constants.TEST_TABLE_NAME, service_name: str = 'cloudwatchlogs',
                               reparse: bool = False, access_key: str = None, secret_key: str = None,
                               profile: str = constants.TEST_AWS_PROFILE, iam_role_arn: str = None,
...
def get_aws_sqs_queue_parameters(name: str = constants.TEST_SQS_NAME, external_id: str = constants.TEST_EXTERNAL_ID,
                                 iam_role_arn: str = constants.TEST_IAM_ROLE_ARN, iam_role_duration: str = None,
