...
@pytest.mark.parametrize('access_key, secret_key, profile', [
    (constants.TEST_ACCESS_KEY, constants.TEST_SECRET_KEY, None),
    (constants.TEST_ACCESS_KEY, None, None),
    (None, constants.TEST_SECRET_KEY, None),
    (None, None, constants.TEST_AWS_PROFILE),
    (None, None, constants.TEST_AWS_PROFILE),
])
